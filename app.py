...
class Product(db.Model):
    ...
    def __init__(self, name, description, price, qty, img):
        self.name = name
...
class ProductSchema(ma.Schema):
    class Meta:
        fields = ('id', 'name', 'description', 'price', 'qty', 'img')
...
def add_product():
    ...
    new_product = Product(name, description, price, qty, img)
...
def login():
    ...
    if userLogin:
        isValid = bcrypt.check_password_hash(userLogin.hash, pwd)
